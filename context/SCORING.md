...
Definitions:
- Congestion: Uses live FAA NAS Status delay minutes when an active traffic-management program exists, then falls back to deterministic baseline tiers for major hubs when the feed has no active program.
